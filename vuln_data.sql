...
786	Session fixation discovered	Session fixation bug discovered in /session endpoint enables reusing another users session token.	high	null	ToolB	/session
